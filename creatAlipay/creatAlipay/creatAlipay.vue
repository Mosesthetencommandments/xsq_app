		...
		<view class="AlipayInformation-box">
			...
			<view class="eait" v-if="isXG">
				...
				<view class="input-box">
					...
					<input type="text" value="" placeholder="输入支付宝账号" disabled="true" @blur="getCardNumber" v-model='card_number'/>
				</view>
				<view class="input-box1">
					<view class="title">确认支付宝账号</view><input type="text" disabled="true" value="" @blur="ConfirmCardNumber" placeholder="确认支付宝账号" v-model='card_number'/>
				</view>
			</view>
			<!-- 新建时显示 -->
			<view class="eait" v-else>
				...
				<view class="input-box">
					<view class="title">支付宝账号</view>
					<input type="text" value="" placeholder="输入支付宝账号" @blur="getCardNumber"  v-model='cardNumber'/>
				</view>
				<view class="input-box1">
					<view class="title">确认支付宝账号</view><input type="text" value="" @blur="ConfirmCardNumber" placeholder="确认支付宝账号" v-model="confirmCardNumber"/>
				</view>
			</view>
