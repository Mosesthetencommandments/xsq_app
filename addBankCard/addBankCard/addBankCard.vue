		...
		<view class="eait-box">
			...
			<view class="eait" v-if="isXG">
				...
				<view class="Text"> 
					...
					<image src="../static/images/APP-qie4_0001.png" mode=""></image>
				</view>
				<view class="input-box">
			...
			<view class="eait" v-else>
				...
				<view class="input-box">
					<view class="title">银行卡卡号</view><input type="number" maxlength="19" placeholder="填写银行卡号" @blur="getCardNumber" v-model="cardNumber"/>
				</view>
				<view class="input-box">
					<view class="title">确认银行卡卡号</view><input type="number" maxlength="19" placeholder="填写银行卡号" @blur="ConfirmCardNumber" v-model="confirmCardNumber"/>
				</view>
