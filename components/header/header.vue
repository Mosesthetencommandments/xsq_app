	...
	<view>
		...
		<view class="header">
			<view class="header-search-left">
				...
				<img class="icon-search" src="../static/images/APP-01_0023_sousuo.png" alt="">
		...
		<!-- 首页消息 --> 
		<view class="earnings-box" v-if="isshow" @click.stop="conceal()">
			<view class="earnings">
				<view class="triangle"></view>
				<view class="triangele-bottom" @click.stop="skip()">
					<!-- 收益列表 -->
