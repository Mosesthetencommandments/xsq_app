			...
			<view class="myBill-card" v-for = "(item,index) in allList" :key = "index">
				<view class="myBill-card-top">
					<view class="bank">
						...
						<img src="../static/images/APP-qie10_0000icon56x56.png" alt="" v-if="item.wallet_type === 2">
						<img src="../static/images/APP-qie10_0001icon56x56.png" alt="" v-if="item.wallet_type === 3">
						<p>提现-{{money[index]}}</p>
					</view>
					<view class="time">
