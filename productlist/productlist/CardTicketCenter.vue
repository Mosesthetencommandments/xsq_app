		...
		<view class="header_title_box">
			<view class="header_title">
				<view class="header_title_left">
					...
					<view class="sdfd">
						<image src="../static/images/APP-qie16_0002.png" mode=""></image>
						<view class="wsed">
			...
			<view class="posterLDL">
				<view class="posterLDL_left">
					...
					<view class="posterLDL_left_poster">
						<image src="../static/images/pingtaishengji.jpg" mode=""></image>
...
.header_title_box{
	...
	.header_title{
		// width:100%;
		height: 160upx;
		background: #ffffff url(../static/images/APP-qie16.png) no-repeat 40upx 30upx;
