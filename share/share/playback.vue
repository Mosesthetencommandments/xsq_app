			...
			<view class="viedo" >
				...
				>
					...
					<view class="cover" v-if="isShow">
						<image class="anN" src="../static/images/APP-qie3_0001_play.png" mode=""></image>
				...
				<view class="fordanmu">
					...
					<view class="shopNumber" id="adf" :animation="animationData" v-if="isShoss">
						<view class="s_img_box">
							<image src="../static/images/APP-qie13_0009_gwcm.png" mode=""></image>
						</view>
						<view>
					...
					<view class="button-box">
						...
						<view class="shop" @click="isliveGoodsList = true">
							...
							<image src="../static/images/bdh3.gif" mode=""></image>
						</view>
						<view class="fenxiang" @click="goLiveToShare(item)">
							<image src="../static/images/APP-qie13_0000_fx.png" mode=""></image>
						</view>
						<view class="fenxiangHB_box" v-if="isFXHB" @click.stop="isFXHB = false">
							<view class="x_box" @click.stop="isFXHB = true">
								...
								<view class="fenxiangXZ_box">
									<image src="../static/images/APP-qie13_0000_.png" mode=""></image>
									<view>长按图片保存</view>
								</view>
							</view>
				...
				<view class="shade-header-box">
					<view class="header-message" @click="attention">
						...
						<view class="message-right" v-if="isFollow">
							<image src="../static/images/APP-qie13_0010_gz.png" mode=""></image>
							关注
						</view>
					</view>
				
					<view class="header-fans">
						<image @click="goBack(item)" class="image" src="../static/images/APP-qie3_0000_.png" mode=""></image>
					</view>
				</view>
				<!-- 公告 -->
				<view class="notice" 
...
<script>
	...
	export default {
		...
		methods:{
			...
			gosssss(item){
				setTimeout(() => {
					let videoContext = wx.createVideoContext('aaa')
					videoContext.play()
				}, 200)
				this.Hanzi()
			...
			goBuy(items){
				uni.navigateTo({
					url:'/buy/buy/buy?product_id=' + items.id
				})
			},
			attention(){
